        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          ...
          <div className={classes.grid}>
            <FormControl margin="normal" required>
              <InputLabel htmlFor="name">Наименование</InputLabel>
              <Input
                name="name"
          ...
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="address.other">Другое</InputLabel>
            <Input
              name="address.other"
              onChange={handleChange}
              onBlur={handleBlur}
          ...
          <p className={classes.formTitle}>Комнаты</p>
          <p className={classes.formTitle}>Уборная</p>
          <div className={classes.grid}>
            <FormControl margin="normal" required>
              <InputLabel htmlFor="rooms.toilet.price">Стоимость уборки</InputLabel>
              <Input
            ...
            <FormControl margin="normal" required>
              <InputLabel htmlFor="rooms.toilet.time">Время уборки</InputLabel>
              <Input
          ...
          <p className={classes.formTitle}>Стандартная комната</p>
          <div className={classes.grid}>
            <FormControl margin="normal" required>
          ...
          <div className={classes.grid}>
            <FormControl margin="normal" required>
              <InputLabel htmlFor="rooms.big.price">Стоимость уборки</InputLabel>
              <Input
            ...
            <FormControl margin="normal" required>
              <InputLabel htmlFor="rooms.big.time">Время уборки</InputLabel>
              <Input
                name="rooms.big.time"
                onChange={handleChange}
                onBlur={handleBlur}
