        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          ...
          <div className={classes.grid}>
            <FormControl margin="normal" fullWidth>
              <InputLabel htmlFor="service">Выбрать сервис</InputLabel>
              <Select
          ...
          <p className={classes.formTitle}>Информация о комнатах</p>
          <div className={classes.grid}>
            <FormControl margin="normal" required>
              <InputLabel htmlFor="roomsCount.standart">Стандартная</InputLabel>
              <Input
            ...
            <FormControl margin="normal" required>
              <InputLabel htmlFor="roomsCount.big">Большая</InputLabel>
              <Input
                name="roomsCount.big"
                onChange={handleChange}
            ...
            <FormControl margin="normal" required>
              <InputLabel htmlFor="roomsCount.toilet">Уборная</InputLabel>
              <Input
          ...
          <div className={classes.grid}>
            <FormControl margin="normal" className={classes.formControl}>
              <InputLabel htmlFor="regularity">Регулярность</InputLabel>
              <Select
          ...
          >
            {company ? "Заказать" : "Найти компанию"}
          </Button>
        </form>
      </Paper>
    </main>
